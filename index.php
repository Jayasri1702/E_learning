...
<title>Learnsmasher's Examinate</title>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#" data-toggle="modal" data-target="#login"><b>ADMIN</b></a></li>
        <li><a href="#" data-toggle="modal" data-target="#myModal"><b>SIGN IN</b></a></li>
        <li><a href="#" data-toggle="modal" data-target="#myModal1"><b>SIGN UP</b></a></li>
         <li><a href="#" data-toggle="modal" data-target="#login2"><b>TEACHER</b></a></li>
...
<div class="jumbotron text-center">
 <!-- <img src="Examinate-.png" style="width:600px;height:300px"> -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color:#000099;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -ADMIN</b></span></h4>
      </div>
...
<div class="modal fade" id="login2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:#000099;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -TEACHER</b></span></h4>
      </div>
      <div class="modal-body title1">
<div class="row">
<div class="col-md-3"></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:#000099;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>SIGNIN -STUDENT</b></span></h4>
      </div>
...
<div class="modal fade" id="myModal1">
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title title1"><span  style="color:#000099;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>SIGNUP -STUDENT</b></span></h4>
      </div>
      <div class="modal-body">
...
<?php if(@$_GET['q7'])
{ echo'<p style="color:#000099;font-size:15px;">'.@$_GET['q7'];}?>
<!-- Button -->
<div class="form-group">
  <label class="col-md-3 control-label" for=""></label>
  <div class="col-md-6"> 
    <input  type="submit"  style="background: #000099;" class="sub" value="Register"  />
  </div>
</div>
</fieldset>
</form>
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <i class="material-icons" style="font-size:60px;color:#000099">group_add</i>
      <h4>e Examination</h4>
...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <h4>Who are we</h4>
  <br>
  <div class="row text-center slideanim" style="margin-right:-387px; margin-left: 188px;">
  <div class="col-sm-4">
      <div class="thumbnail">
        <img id="img1" src="photo.jpg" alt="HARIHARANK" >
        <p><strong>HARIHARAN K</strong></p>
        <h4>4th Year at Vellore Institute of Technology,Vellore</h4>
      </div>
    </div>
  <div class="col-sm-4">
      <div class="thumbnail">
        <img id="img2" src="profilepic.jpg" alt="JAYASRI S" >
        <p><strong>JAYA SRI S</strong></p>
        <h4>4th Year at Vellore Institute of Technology,Vellore</h4>
      </div>
    </div>
  ...
  <h2 style="color: Dark Blue">What Our Developers Says!</h2>
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"All our dreams can come true, if We Have the Courage to Pursue Them!"<br><span>Walt Disney</span></h4>
      </div>
      <div class="item">
        <h4>" I wake up every morning and think to myself, 'How far can i push this company in the next 24 hours'"<br><span>Leah Busque</span></h4>
      </div>
      <div class="item">
        <h4>"One Day or Day one! You Decide"<br><span>Our Developers - Hariharan K and Jayasri S  </span></h4>
      </div>
      <div class="item">
        <h4>"If you're offered a seat on a rocket ship, don't ask what seat! Just get on!!"<br><span>Sheryly Sandberg </span></h4>
      </div>
      <div class="item">
        <h4>"The World is full of nice people. If you can't find one, Be One"<br><span> Nishan Panwar </span></h4>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  <h2 class="text-center" style="color: Dark Blue">Feel Free to Contact Us!</h2>
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-envelope"></span> Learnsmasher@gmail.com</p>
    </div>
...
<footer class="container-fluid text-center">
  ...
  <h4><b>Thank you for visiting us.<b></h4>
</footer>
