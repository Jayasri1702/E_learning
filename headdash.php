...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="headdash.php" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=headdash.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="headdash.php?q=0">Exam-Details<span class="sr-only">(current)</span></a></li>
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="headdash.php?q=1">Students Enrolled</a></li>
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="headdash.php?q=2">Student's Ranking</a></li>
...
<tr><td><b>S.No</b></td><td><b>List of Exams</b></td><td><b>Total Questions</b></td><td><b>Total Marks</b></td><td><b>Positive Marks </b></td><td><b>Negative Marks</b></td><td><b>Time Limit</b></td><td></td></tr>';
$c=1;
...
if($rowcount == 0){
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$sahi.'</td><td>'.$wrong.'</td><td>'.$time.'&nbsp;mins</td>
	</tr>';
}
else
{
...
<tr ><td><b>Rank</b></td><td><b> Student Name</b></td><td><b>Gender</b></td><td><b>College</b></td><td><b>Score</b></td></tr>';
$c=0;
...
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>S.No</b></td><td><b>Student Name</b></td><td><b>Gender</b></td><td><b>College</b></td><td><b>Email ID</b></td><td><b>Mobile No.</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>S.No</b></td><td><b>Feedback Details</b></td><td><b>Email ID</b></td><td><b>Date</b></td><td><b>Time</b></td><td><b>Submitted By</b></td><td></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$date = $row['date'];
